...
#Variables 
$COND_DEF_DIR    = "C:\Users\z2h8636\Documents\script_kicker-master"
$bat_defines_hash = @(@{
                        bat_dir= "C:\Windows\System32"
                        bat_name= "batA"
                        cond_def= "def1.ps1"
                        flag_path= "C:\Users\z2h8636\Documents\script_kicker-master\FLAG_1"
                        };
                      @{
                        bat_dir= "C:\Windows\System32"
                        bat_name= "batB"
                        cond_def= "def2.ps1"
                        flag_path= "C:\Users\z2h8636\Documents\script_kicker-master\FLAG_2"
                        }
                      )
    ...
    $bat_defines_hash.GetEnumerator() | ForEach-Object{
        ...
        if($def.dateCheck.checkSkip -eq $false -and `
            (checkDate $def.dateCheck.lastUpdate) -eq $false ){
                ...
                write-Error "JSON file import error. Check def1.json or def2.json"
                return
        }
